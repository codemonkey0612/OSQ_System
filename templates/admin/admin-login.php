<?php
/**
 * Administrator Login Page Template.
 *
 * @package OSQ
 */
...
<div id="osq-admin-login" class="osq-ui-container">
	<div class="osq-login-card osq-login-card--admin">
		...
		<form method="post" action="" class="osq-form">
			<?php wp_nonce_field( 'osq_admin_login_action', 'osq_admin_login_nonce' ); ?>
